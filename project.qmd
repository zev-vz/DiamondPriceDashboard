...
```{r,echo=FALSE, message=FALSE, warning=FALSE}
#I decided to make this a standalone chunk even though I could have relied on the previous chunk to make it more accessible and usable to a wider range of audiences.
...
ui <- fluidPage(
  ...
  #Creating a layout for our sidebar, complete with choices and inputs pulled from our data to allow us to take inputs from users
  sidebarLayout(
    sidebarPanel(
      class = "panel",
